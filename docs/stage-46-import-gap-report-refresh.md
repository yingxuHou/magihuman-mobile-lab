...
No real GPU evidence package has been imported yet. After Stage 50, the tracked gap report is `awaiting_gpu_runtime` with the P01 budget guard ready; the recommendation remains `B_pending_runtime`.
